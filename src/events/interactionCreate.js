import { getRandomQuestion, buildQuestionEmbed, buildQuestionComponents, resolveNsfw, rollAndiTax, buildAndiTaxEmbed, disableComponents, expireButtons } from "../utils/helpers.js";
...
export async function execute(interaction, commands) {
  ...
  if (interaction.isButton() && id in BUTTON_TYPE_MAP) {
    // Disable buttons on the message that was clicked immediately
